...
// DESKTOP: import * as fs from 'original-fs';
// DESKTOP: import * as path from 'path';
// DESKTOP: import * as os from 'os';
// DESKTOP: import { app } from 'electron';
...
// DESKTOP: import product, { IProductConfiguration } from 'vs/platform/product';
...
function parsePathArguments(cwd: string, args: string[], gotoLineMode?: boolean): string[] {
	const result = args.map(arg => {
		...
		if (basename && !paths.isValidBasename(basename)) {
