...
export class ConfigurationService<T> implements IConfigurationService, IDisposable {
	...
	constructor(
		...
		@IExlcodeService exlcodeService: IExlcodeService
	) {
		this.disposables = [];
		...
		this.rawConfig = new ConfigWatcher(environmentService.appSettingsPath, { changeBufferDelay: 300, defaultConfig: Object.create(null) }, eventService, exlcodeService);
